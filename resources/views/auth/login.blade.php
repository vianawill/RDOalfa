...
<body class="body-bg pt-9 md:pt-15 pb-1 px-2 md:px-0  ">
        ...
        <section class=" mt-10">
            <form class="flex flex-col" method="POST" action="{{ route('login') }}">
                ...
                <div class="flex justify-end">
                    <a href="{{ route('password.request') }}" class="text-sm text-txtblue hover:text-blue-800 hover:underline mb-6">
                        Esqueceu sua senha?
                    </a>
                </div>
    ...
    <!-- LINK CADASTRE-SE -->
    <div class="max-w-lg mx-auto text-center mt-8 mb-6">
    ...
    <!-- INICIO FOOTER -->
    <footer class=" max-w-lg mx-auto mb-5 flex justify-center text-gray-400 pb-2 hover:text-gray-600">
